...
Server is packaged as a web archive (`war`) deployed and tested in [Tomcat](http://tomcat.apache.org) (either regular or embedded with [Webapp Runner](https://github.com/jsimone/webapp-runner)). Regular Tomcat was used locally while embedded Tomcat was used both locally and within [Heroku](https://www.heroku.com).
